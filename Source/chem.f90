...
CHARACTER(KIND=C_CHAR) :: MOD_NAME
CHARACTER(KIND=C_CHAR) :: FUNC_NAME
CHARACTER(KIND=C_CHAR) :: MESSAGE
TYPE(C_PTR), VALUE    :: USER_DATA        ! USER-DEFINED DATA

! PRINT OUT THE ERROR INFORMATION
IF (DEBUG) THEN
   WRITE(LU_ERR,*) 'CVODE ERROR HANDLER:'
   WRITE(LU_ERR,*) '  ERROR CODE   : ', ERR_CODE
   WRITE(LU_ERR,*) '  MODULE       : ', MOD_NAME
   WRITE(LU_ERR,*) '  FUNCTION     : ', FUNC_NAME
   WRITE(LU_ERR,*) '  MESSAGE      : ', MESSAGE
   IF (.NOT. C_ASSOCIATED(USER_DATA)) WRITE(LU_ERR,*)" NO USER_DATA IS PROVIDED"
ENDIF
