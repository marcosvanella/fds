...
USE CC_SCALARS,   ONLY: CC_SET_DATA,CC_END_STEP,CC_DENSITY,CC_RHO0W_INTERP,       &
                        ...
                        BEGIN_FV_L2_ROWS,FINALIZE_FV_L2_ROWS
USE OPENMP_FDS
USE MPI_F08
...
CALL BEGIN_FV_L2_ROWS(CC_FV_L2_THERMO)

DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
   CALL DIVERGENCE_PART_1(T_BEGIN,DT,NM)
ENDDO

CALL FINALIZE_FV_L2_ROWS(CC_FV_L2_THERMO)
...
MAIN_LOOP: DO
   ...
   CHANGE_TIME_STEP_LOOP: DO
      ...
      CALL FINALIZE_FV_L2_ROWS(CC_FV_L2_CFLVN,DT,DT_NEW,T+DT)
