      ...
      MESH_LOOP_SERIAL : DO NM=LOWER_MESH_INDEX,UPPER_MESH_INDEX
         ...
         IF (CC_IBM) THEN
            ...
            DO NC=1,NCHEM_ACTIVE_CC
               ...
               ENDIF
               CALL SET_SPECIES_SOURCE_TERM_CUTCELL(DT,NM,ICC,JCC,ICV,ZZ_GET,DZZ,REAC_SOURCE_TERM_TMP,Q_REAC_TMP)
            END DO
         ENDIF
         IF(ALLOCATED(DZ_F0)) DEALLOCATE(DZ_F0)
         IF (STOP_STATUS/=NO_STOP) RETURN
...
SUBROUTINE SET_SPECIES_SOURCE_TERM_CUTCELL(DT,NM,ICC,JCC,ICV,ZZ_NEW,ZZ_OLD,REAC_SOURCE_TERM_TMP,Q_REAC_TMP)
