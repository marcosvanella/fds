...
USE MESH_POINTERS
USE CC_SCALARS, ONLY: GET_FV_CV_FOR_CUTCELL
            ...
            DO NC=1,NCHEM_ACTIVE_CC
               ...
               ELSE
                  ...
                  CALL COMBUSTION_MODEL(T,DT,ZZ_GET,CV%Q(CC%IG(JCC)),CV%MIX_TIME(CC%IG(JCC)),CV%CHI_R(CC%IG(JCC)),&
                                        CHEM_SUBIT_TMP,REAC_SOURCE_TERM_TMP,Q_REAC_TMP,CC%TMP(JCC),CC%RHO(JCC),PRES,MU(I,J,K),&
...
DZZ_IF2: IF ( ANY(ABS(DZZ) > DZZ_CLIP) ) THEN
   ...
   ELSE
      ...
      DO N=1,N_TRACKED_SPECIES
         ...
         CV%M_DOT_PPP(N,IG)=CV%M_DOT_PPP(N,IG)+CUT_CELL(ICC)%RHO(JCC)*DZZ(N)/DT
      ENDDO
   ENDIF
ENDIF DZZ_IF2
