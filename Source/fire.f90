...
ELSE IF(SORTED_RANK_INDX_MAP(MY_RANK+1) >= AVG_PIVOT_INDX) THEN ! Only recieve.
   ...
   NCELLS_TO_RECV_ARRAY_ALGO2(TOT_RANK_TO_COMM,2) = CELLS_PER_SORTED_RANK(SORTED_RANK_INDX_MAP(MY_RANK+1))
...
REAL(EB) :: A1(1:N_TRACKED_SPECIES),A2(1:N_TRACKED_SPECIES),A4(1:N_TRACKED_SPECIES),ZETA,ZETA_0,&
            ...
            ZZ_TEMP(1:N_TRACKED_SPECIES), ATOL(1:N_TRACKED_SPECIES), DZ_F0(N_REACTIONS), MOLPCM3
...
INTEGRATION_LOOP: DO TIME_ITER = 1,MAX_CHEMISTRY_SUBSTEPS
   ...
   INTEGRATOR_SELECT: SELECT CASE (COMBUSTION_ODE_SOLVER)
      ...
      CASE (EXPLICIT_EULER) ! Simple chemistry
         ...
         CALL FIRE_FORWARD_EULER(ZZ_MIXED_NEW,ZZ_MIXED,ZZ_0,ZETA,ZETA_0,DT_SUB,TMP_IN,RHO_HAT,DZ_F0,MOLPCM3, &
      ...
      CASE (RK2_RICHARDSON) ! Finite-rate (or mixed finite-rate/fast) chemistry
         ...
         RICH_EX_LOOP: DO RICH_ITER = 1,RICH_ITER_MAX
            ...
            CALL FIRE_RK2(A1,ZZ_MIXED,ZZ_0,ZETA_1,ZETA_0,DT_SUB,1,TMP_IN,RHO_HAT,DZ_F0,MOLPCM3,CELL_MASS,TAU_MIX,&
                        Q_REAC_1,TOTAL_MIXED_MASS_1,NO_REACTIONS)
            IF (NO_REACTIONS) EXIT RICH_EX_LOOP
            CALL FIRE_RK2(A2,ZZ_MIXED,ZZ_0,ZETA_2,ZETA_0,DT_SUB,2,TMP_IN,RHO_HAT,DZ_F0,MOLPCM3,CELL_MASS,TAU_MIX,&
                        Q_REAC_2,TOTAL_MIXED_MASS_2,NO_REACTIONS)
            CALL FIRE_RK2(A4,ZZ_MIXED,ZZ_0,ZETA_4,ZETA_0,DT_SUB,4,TMP_IN,RHO_HAT,DZ_F0,MOLPCM3,CELL_MASS,TAU_MIX,&
...
SUBROUTINE FIRE_FORWARD_EULER(ZZ_OUT,ZZ_IN,ZZ_0,ZETA_OUT,ZETA_IN,DT_LOC,TMP_IN,RHO_HAT,DZ_F0,MOLPCM3,CELL_MASS,TAU_MIX,&
...
REAL(EB), INTENT(INOUT) :: TMP_IN, DZ_F0(N_REACTIONS),MOLPCM3
...
IF (ANY(REACTION%FAST_CHEMISTRY)) THEN
   DO PTY = 1,MAX_PRIORITY
      CALL REACTION_RATE(DZZ,ZZ_HAT,DT_LOC,RHO_HAT,TMP_IN,DZ_F0,MOLPCM3,INFINITELY_FAST,Q_REAC_OUT,NO_REACTIONS,PRIORITY=PTY)
      ZZ_HAT = ZZ_HAT + DZZ
...
IF (.NOT.ALL(REACTION%FAST_CHEMISTRY)) THEN
   CALL REACTION_RATE(DZZ,ZZ_HAT,DT_LOC,RHO_HAT,TMP_IN,DZ_F0,MOLPCM3,FINITE_RATE,Q_REAC_OUT,NO_REACTIONS)
   ZZ_HAT = ZZ_HAT + DZZ
   Q_REAC_LOC = Q_REAC_LOC + Q_REAC_OUT*TOTAL_MIXED_MASS
ENDIF
...
SUBROUTINE FIRE_RK2(ZZ_OUT,ZZ_IN,ZZ_0,ZETA_OUT,ZETA_IN,DT_SUB,N_INC,TMP_IN,RHO_HAT,DZ_F0,MOLPCM3,CELL_MASS,TAU_MIX,&
...
REAL(EB), INTENT(INOUT) :: DZ_F0(N_REACTIONS),MOLPCM3
...
DO N=1,N_INC
   CALL FIRE_FORWARD_EULER(ZZ_TMP_1,ZZ_TMP_0,ZZ_0,ZETA_TMP_1,ZETA_TMP_0,DT_LOC,TMP_IN,RHO_HAT,DZ_F0,MOLPCM3,CELL_MASS,TAU_MIX,&
                           Q_REAC_1,TOTAL_MIXED_MASS_1,NO_REACTIONS)

   CALL FIRE_FORWARD_EULER(ZZ_TMP_2,ZZ_TMP_1,ZZ_0,ZETA_TMP_2,ZETA_TMP_1,DT_LOC,TMP_IN,RHO_HAT,DZ_F0,MOLPCM3,CELL_MASS,TAU_MIX,&
                           Q_REAC_2,TOTAL_MIXED_MASS_2,NO_REACTIONS)
...
SUBROUTINE REACTION_RATE(DZZ,ZZ_OLD,DT_SUB,RHO_0,TMP_0,DZ_F0,MOLPCM3,KINETICS,Q_REAC_OUT,NO_REACTIONS,PRIORITY)
