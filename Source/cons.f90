...
INTEGER :: N_SLCF_O=0, N_SLCF_TOT=0
INTEGER :: N_UNIQUE_SLCF=0
CHARACTER(MESSAGE_LENGTH), ALLOCATABLE, DIMENSION(:) :: UNIQUE_SLICE_NAMES, ALL_SLICE_NAMES, ALL_SLICE_QUANTITIES
INTEGER, ALLOCATABLE, DIMENSION(:) :: ALL_SLICE_TOPOLOGIES
LOGICAL, ALLOCATABLE, DIMENSION(:) :: UNIQUE_SLICE_IS_SL3D
