...
LOGICAL  :: CC_USE_SET_CVS_3D=.FALSE.
LOGICAL  :: CC_CV_ENABLE_CROSS_MESH_LINKING=.FALSE.
LOGICAL  :: CC_CV_USE_IN_SOLVER=.FALSE.
INTEGER  :: CC_CV_SOLVER_SCOPE=0
INTEGER, PARAMETER :: CC_CV_SCOPE_IDENTITY=0, CC_CV_SCOPE_SAME_MESH=1, CC_CV_SCOPE_CROSS_MESH=2
LOGICAL  :: CC_CV_H_PER_MEMBER=.TRUE.
! Cross-mesh row reduce phase for main.f90 BEGIN/FINALIZE_FV_L2_ROWS(MODE).
INTEGER, PARAMETER :: CC_FV_L2_THERMO=1, CC_FV_L2_CFLVN=2
INTEGER, PARAMETER :: CC_FACE_ROLE_EXTERNAL=0, CC_FACE_ROLE_INTERNAL=1
INTEGER, PARAMETER :: CC_FACE_KIND_GAS=0, CC_FACE_KIND_WALL=1, CC_FACE_KIND_EXTERNAL=2, &
                      CC_FACE_KIND_REMOTE=3, CC_FACE_KIND_REFINE=4, CC_FACE_KIND_COUPLING=5
INTEGER, PARAMETER :: CC_FACE_REF_CV_CENTER=0, CC_FACE_REF_GCELL_CENTROID=1, CC_FACE_REF_RAW_CELL_CENTROID=2
